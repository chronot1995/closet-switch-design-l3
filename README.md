...
This is an Ansible demo to configure an L3 branch / closet design
...
```
     ./topology_converter.py closet-switch-design-l3.dot -c --provider=virtualbox
     ./topology_converter.py closet-switch-design-l3.dot -c --provider=libvirt
```
