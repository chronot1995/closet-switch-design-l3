...
#    using topology data from: closet-switch-design-l2.dot
...
REPOSITORY="https://github.com/CumulusNetworks/closet-switch-design-l2"
REPONAME="closet-switch-design-l2"
